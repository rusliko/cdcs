...
git clone https://github.com/jagoanpilot/jagoancoin
...
```bash
    ...
    From https://github.com/jagoanpilot/jagoancoin
...
[jagoancoin/gitian.sigs](https://github.com/jagoanpilot/gitian.sigs/) repository, or if that's not possible to create a pull
request.
