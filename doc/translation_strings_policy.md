...
This document provides guidelines for internationalization of the Jagoancoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `jagoancoin_en.ts` remains unchanged.
