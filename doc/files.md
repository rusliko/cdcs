...
* jagoancoin.conf: contains configuration settings for jagoancoind or jagoancoin-qt
* jagoancoind.pid: stores the process id of jagoancoind while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by jagoancoind or jagoancoin-qt
