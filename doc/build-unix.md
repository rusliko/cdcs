UNIX BUILD NOTES
====================
Some notes on how to build Jagoancoin Core in Unix.

(for OpenBSD specific instructions, see [build-openbsd.md](build-openbsd.md))

Base build dependencies
-----------------------
Building the dependencies and Jagoancoin Core requires some essential build tools and libraries to be installed before.
...
Security
--------
To help make your Jagoancoin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, Jagoancoin Core should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, Jagoancoin Core may be compiled in
