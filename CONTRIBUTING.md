Contributing to CDCS Core
============================

The CDCS Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Raptor3um/CDCS/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the CDCS Core project (and related
projects such as libsecp256k1), and is not to be confused with overall CDCS
Network Protocol consensus changes.

Whether a pull request is merged into CDCS Core rests with the project merge
...
Patches that change CDCS consensus rules are considerably more involved than
...
Where a patch set proposes to change the CDCS consensus, it must have been
...
The review process is normally fairly responsive on the CDCS Core repository, however
...
The project leader is the release manager for each CDCS Core release.
