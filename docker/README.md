...
official/supported Docker Images found at https://hub.docker.com/r/jagoancoin/jagoancoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/jagoancoin/jagoancoind-develop/ when changing the above text**