...
//
//     src/qt/test/test_jagoancoin-qt -platform xcb      # Linux
//     src/qt/test/test_jagoancoin-qt -platform windows  # Windows
//     src/qt/test/test_jagoancoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(2).indexOf(QString("URI: jagoancoin:")) != -1);
