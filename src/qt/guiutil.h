...
/** Utility functions used by the Jagoancoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "jagoancoin:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load jagoancoin specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a jagoancoin specific theme is activated (light/dark).*/
