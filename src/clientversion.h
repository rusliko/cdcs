...
#error Client version information missing: version is not defined by jagoancoin-config.h or in any other way
#endif
...
/**
 * jagoancoind-res.rc includes this file, but it cannot cope with real c++ code.
