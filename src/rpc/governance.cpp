...
UniValue gobject_vote_conf(const JSONRPCRequest& request)
{
    ...
    if (!dmn) {
        ...
        resultsObj.push_back(Pair("jagoancoin.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Jagoancoin features */
    { "jagoancoin",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "jagoancoin",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "jagoancoin",               "gobject",                &gobject,                true,  {} },
    { "jagoancoin",               "voteraw",                &voteraw,                true,  {} },
