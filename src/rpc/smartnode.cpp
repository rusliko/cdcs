...
void smartnode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the smartnode owner Jagoancoin address\n"
            "  payee          - Print the smartnode payout Jagoancoin address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the smartnode operator public key\n"
            "  status         - Print smartnode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the smartnode voting Jagoancoin address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "jagoancoin",               "smartnode",             &smartnode,             true,  {} },
    { "jagoancoin",               "smartnodelist",         &smartnodelist,         true,  {} },
};
