...
UniValue echo(const JSONRPCRequest& request)
{
    if (request.fHelp)
        throw std::runtime_error(
            ...
            "jagoancoin-cli and the GUI. There is no server-side difference."
        );
...
static UniValue getinfo_deprecated(const JSONRPCRequest& request)
{
    throw JSONRPCError(RPC_METHOD_NOT_FOUND,
        ...
        "\njagoancoin-cli has the option -getinfo to collect and format these in the old format."
    );
}
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Jagoancoin features */
    { "jagoancoin",               "mnsync",                 &mnsync,            {} },
    { "jagoancoin",               "spork",                  &spork,             {"arg0","value"} },
