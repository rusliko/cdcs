...
UniValue getinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total jagoancoin balance of the wallet\n"
...
UniValue debug(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            " - \"jagoancoin\" activates all Jagoancoin-specific categories at once;\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("debug", "jagoancoin")
            + HelpExampleRpc("debug", "jagoancoin+net")
        );
...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nReturn information about the given jagoancoin address.\n"
            "\nArguments:\n"
            "1. \"address\"     (string, required) The jagoancoin address to validate\n"
            "\nResult:\n"
            "{\n"
...
#ifdef ENABLE_WALLET
        // Case 1: Jagoancoin address and we have full public key:
...
UniValue createmultisig(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 2)
    {
        std::string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are jagoancoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) jagoancoin address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The jagoancoin address to use for the signature.\n"
...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Jagoancoin features */
    { "jagoancoin",               "mnsync",                 &mnsync,                 true,  {} },
    { "jagoancoin",               "spork",                  &spork,                  true,  {"value"} },
