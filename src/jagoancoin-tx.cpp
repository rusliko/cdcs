...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf("%s jagoancoin-tx utility version", PACKAGE_NAME) + " " + FormatFullVersion() + "\n\n" +
            "Usage:\n"
              "  jagoancoin-tx [options] <hex-tx> [commands]  Update hex-encoded jagoancoin transaction\n" +
              "  jagoancoin-tx [options] -create [commands]   Create hex-encoded jagoancoin transaction\n" +
              "\n";
