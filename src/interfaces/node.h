...
//! Interface for the src/evo part of a jagoancoin node (jagoancoind process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a jagoancoin node (jagoancoind process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a jagoancoin node (jagoancoind process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a jagoancoin node (jagoancoind process).
class Node
{
public:
    virtual ~Node() {}
