# Linearize
Construct a linear, no-fork, best version of the Jagoancoin blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install jagoancoin_hash

https://github.com/jagoanpilot/jagoancoin_hash
...
JSON-RPC server. Running `jagoancoind` or `jagoancoin-qt -server` will be sufficient.
...
* `input`: jagoancoind blocks/ directory containing blkNNNNN.dat
