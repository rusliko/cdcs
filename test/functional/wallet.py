...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 210 JAGOANCOIN from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 JAGOANCOIN in block rewards plus fees, but
        ...
        # Send 100 JAGOANCOIN with subtract fee from amount
        ...
        # Sendmany 100 JAGOANCOIN with subtract fee from amount
