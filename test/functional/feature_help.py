...
"""Verify that starting jagoancoind with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start jagoancoind with -h for help text")
        ...
        self.log.info("Start jagoancoind with -version for version information")
