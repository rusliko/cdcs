...
# Copyright (c) 2022 The Jagoancoin Endeavor developers
...
class LLMQCoinbaseCommitmentsTest(JagoancoinTestFramework):
    def set_test_params(self):
        self.set_jagoancoin_test_params(4, 3, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as JagoancoinTestFramework doesn't support this atm)
